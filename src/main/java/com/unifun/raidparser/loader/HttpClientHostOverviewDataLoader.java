...
public class HttpClientHostOverviewDataLoader implements HostOverviewDataLoader {
    private static final Logger LOGGER = LogManager.getLogger(HttpClientHostOverviewDataLoader.class);
